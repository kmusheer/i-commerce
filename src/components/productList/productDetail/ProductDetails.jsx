...
import { fetchProductByIdAsync, selectProductId, selectProductListStatus } from '../../../redux/productSlice'
import { useParams } from 'react-router-dom'
import { addToCartAsync, selectItem } from '../../../redux/cartSlice'
...
export default function ProductDetail() {
  ...
  const handleCart = (e) => {
    e.preventDefault();
    // dispatch(addToCartAsync({...product,quantity:1,user:user[0].id }))
    if (items.findIndex((item) => item.productId === product.id) < 0) {
      ...
      toast.success('🛒 product added inot Cart!', {
